...
export interface SiteArTranslations {
  // Intro
  introText: string;
  ...
  featuredLiveLabel: string;
  featuredViewAllLabel: string;
  featuredCtaTitleLine1: string;
  featuredCtaTitleLine2: string;
  featuredCtaDescription: string;
  featuredCtaButtonText: string;
  // Navigation
  navHome: string;
  navAbout: string;
  navProjects: string;
  ...
  scene05Badge: string;
  scene05Role: string;
  scene05VisionTitle: string;
  scene05VisionText: string;
  scene05StoryTitle: string;
  scene05SkillsTitle: string;
  scene05CertificationsTitle: string;
  scene05CredentialButtonLabel: string;
  scene05CompanyLogosTitle: string;
  scene05AiTitle: string;
  scene05AiText: string;
  scene05ActionLabel: string;
  // Footer
  ...
  articlesLatestLabel: string;
  articlesAllTopicsLabel: string;
  articlesSearchPlaceholder: string;
  articlesContinueReadingLabel: string;
  articlesMinReadLabel: string;
  articlesUndatedLabel: string;
  articlesByAuthorPrefix: string;
  articlesNotFoundTitle: string;
  articlesNotFoundDescription: string;
  articlesBackLabel: string;
  articlesFeaturedLabel: string;
  articlesNoResultsTitle: string;
  articlesNoResultsDescription: string;
  articlesPreviousLabel: string;
  articlesNextLabel: string;
  articlesNewsletterTitle: string;
  articlesNewsletterDescription: string;
  articlesNewsletterInputPlaceholder: string;
  articlesNewsletterButtonLabel: string;
  articlesVideosSectionTitle: string;
  articlesVideosSectionDescription: string;
  // Contact page
  contactHeroTitleLine1: string;
  contactHeroTitleLine2: string;
  ...
  contactResponseTimeDescription: string;
  ...
  contactSocialSectionLabel: string;
  contactSocialSectionTitle: string;
  contactSocialSectionDescription: string;
  contactFormSuccessTitle: string;
  contactFormSuccessMessage: string;
  contactValidationRequired: string;
  contactValidationInvalidEmail: string;
  contactValidationMinLength: string;
}

export interface SiteConfig {
  language: 'en' | 'ar';
  arTranslations: SiteArTranslations;
  introText: string;
  introScrollPrompt: string;
...
export const DEFAULT_AR_TRANSLATIONS: SiteArTranslations = {
  introText: 'أصمم منتجات رقمية مدروسة وتجارب مستخدم سينمائية تربط احتياجات المستخدم بنجاح الأعمال من خلال الذكاء الاصطناعي.',
  introScrollPrompt: 'مرر للاستكشاف',
  featuredTitleLine1: 'أعمال',
  featuredTitleLine2: 'مميزة',
  featuredDescription: 'مجموعة من التجارب الرقمية الغامرة التي صُنعت للعلامات التجارية الطموحة والفرق المبتكرة.',
  featuredCaseStudyLabel: 'دراسة حالة',
  featuredLiveLabel: 'التطبيق الحي',
  featuredViewAllLabel: 'عرض جميع المشاريع',
  featuredCtaTitleLine1: 'ارتقِ بمنتجك',
  featuredCtaTitleLine2: 'إلى المستوى التالي',
  featuredCtaDescription: 'احصل على رؤية كاملة لتجربتك الرقمية. دعنا نصمم واجهات بديهية وجذابة وعالية الأداء تحقق نتائج حقيقية للأعمال.',
  featuredCtaButtonText: 'ابدأ مشروعاً',
  navHome: 'الرئيسية',
  navAbout: 'من أنا',
  ...
  letsTalkLabel: 'لنتحدث',
  scene05Badge: 'من أنا',
  scene05Role: 'مصمم UX وباني منتجات الذكاء الاصطناعي',
  scene05VisionTitle: 'الرؤية والقيمة',
  scene05VisionText: 'أصمم واجهات ليست مصقولة بصرياً فحسب، بل منظمة بشكل مقصود. هدفي بناء منتجات رقمية تبدو طبيعية للمستخدمين ومربحة للغاية للأعمال.',
  scene05StoryTitle: 'ما أقدمه فعلاً',
  scene05SkillsTitle: 'المهارات الأساسية',
  scene05CertificationsTitle: 'الشهادات',
  scene05CredentialButtonLabel: 'عرض الشهادة',
  scene05CompanyLogosTitle: 'شركات تعاونت معها',
  scene05AiTitle: 'التصميم مع الذكاء الاصطناعي',
  scene05AiText: 'تتحول مسيرتي نحو منتجات مدعومة بالذكاء الاصطناعي. أعتقد أن الذكاء الاصطناعي يتحقق من خلال تفاعلات مصممة جيداً، باستخدامه كأداة لتعزيز الوضوح والكفاءة والجدوى التجارية.',
  scene05ActionLabel: 'تواصل معي',
  footerCopyrightText: 'أسامة لاسويد. جميع الحقوق محفوظة.',
  footerOfficeTitle: 'مكتب أسامة',
  articlesTitle: 'المجلة والمقالات',
  articlesSubtitle: 'رؤى حول المنتج، تجربة المستخدم، والذكاء الاصطناعي',
  articlesDescription: 'فضاء نشر لدراسات الحالة وتفكير المنتج وصياغة الواجهات وسير عمل الذكاء الاصطناعي العملية.',
  articlesLatestLabel: 'أحدث المقالات',
  articlesAllTopicsLabel: 'الكل',
  articlesSearchPlaceholder: 'ابحث في المقالات...',
  articlesContinueReadingLabel: 'تابع القراءة',
  articlesMinReadLabel: 'دقيقة قراءة',
  articlesUndatedLabel: 'غير مؤرخ',
  articlesByAuthorPrefix: 'بقلم',
  articlesNotFoundTitle: 'المقال غير موجود',
  articlesNotFoundDescription: 'هذا المقال غير موجود أو غير منشور حالياً.',
  articlesBackLabel: 'العودة إلى جميع المقالات',
  articlesFeaturedLabel: 'مقال مميز',
  articlesNoResultsTitle: 'لم تتطابق نتائج مع بحثك',
  articlesNoResultsDescription: 'جرب كلمة أخرى أو انتقل إلى فلتر موضوع آخر.',
  articlesPreviousLabel: 'السابق',
  articlesNextLabel: 'التالي',
  articlesNewsletterTitle: 'لا تفوّت مقالاً جديداً',
  articlesNewsletterDescription: 'اشترك في النشرة الإخبارية واحصل على مقالات جديدة فور نشرها.',
  articlesNewsletterInputPlaceholder: 'بريدك الإلكتروني',
  articlesNewsletterButtonLabel: 'اشترك',
  articlesVideosSectionTitle: 'منشورات الفيديو',
  articlesVideosSectionDescription: 'شروحات بصرية قصيرة، جولات وعروض توضيحية منشورة إلى جانب المقالات المكتوبة.',
  contactHeroTitleLine1: 'تواصل معنا',
  contactHeroTitleLine2: 'لنعمل معاً',
  contactHeroSubtitle: 'هل لديك مشروع في ذهنك أو تريد استكشاف فرص؟ أنا دائماً منفتح على مناقشة مشاريع جديدة وأفكار إبداعية أو شراكات.',
  contactDirectContactTitle: 'التواصل المباشر',
  contactPhoneLabel: 'الهاتف',
  contactEmailLabel: 'البريد الإلكتروني',
  contactOfficeLabel: 'المكتب',
  contactAvailabilityText: 'متاح للمشاريع في جميع أنحاء العالم',
  contactResponseTimeLabel: 'وقت الاستجابة',
  contactResponseTimeDescription: 'عادةً ما أرد خلال يوم عمل واحد',
  contactFormTitle: 'أرسل رسالة',
  contactFormSubtitle: 'يسعدني سماعك. املأ النموذج أدناه وسأرد عليك في أقرب وقت.',
  contactFormNameLabel: 'اسمك',
  contactFormNamePlaceholder: 'محمد أحمد',
  contactFormEmailLabel: 'البريد الإلكتروني',
  contactFormEmailPlaceholder: 'ahmed@company.com',
  contactFormSubjectLabel: 'الموضوع',
  contactFormSubjectPlaceholder: 'استفسار عن مشروع',
  contactFormMessageLabel: 'الرسالة',
  contactFormMessagePlaceholder: 'أخبرني عن مشروعك...',
  contactFormPrivacyText: 'بالإرسال، أنت توافق على',
  contactFormSubmitButton: 'إرسال الرسالة',
  contactSocialSectionLabel: 'القنوات الاجتماعية',
  contactSocialSectionTitle: 'تواصل على وسائل التواصل',
  contactSocialSectionDescription: 'تابعني على وسائل التواصل الاجتماعي للحصول على تحديثات ومحتوى خلف الكواليس والمزيد.',
  contactFormSuccessTitle: 'تم إرسال الرسالة!',
  contactFormSuccessMessage: 'شكراً على تواصلك. لقد استلمت رسالتك وسأرد عليك خلال 24 ساعة.',
  contactValidationRequired: 'هذا الحقل مطلوب',
  contactValidationInvalidEmail: 'يرجى إدخال بريد إلكتروني صالح',
  contactValidationMinLength: 'يجب أن تكون الرسالة 10 أحرف على الأقل',
};

export const DEFAULT_SITE_CONFIG: SiteConfig = {
  language: 'en',
  arTranslations: DEFAULT_AR_TRANSLATIONS,
  introText:
...
export const hydrateSiteConfig = (value: unknown): SiteConfig => {
  ...
  return {
    language: (value.language === 'ar' ? 'ar' : 'en') as 'en' | 'ar',
    arTranslations: (() => {
      const ar = isRecord(value.arTranslations) ? value.arTranslations : {};
      const def = DEFAULT_AR_TRANSLATIONS;
      return {
        introText: asString(ar.introText, def.introText),
        introScrollPrompt: asString(ar.introScrollPrompt, def.introScrollPrompt),
        featuredTitleLine1: asString(ar.featuredTitleLine1, def.featuredTitleLine1),
        featuredTitleLine2: asString(ar.featuredTitleLine2, def.featuredTitleLine2),
        featuredDescription: asString(ar.featuredDescription, def.featuredDescription),
        featuredCaseStudyLabel: asString(ar.featuredCaseStudyLabel, def.featuredCaseStudyLabel),
        featuredLiveLabel: asString(ar.featuredLiveLabel, def.featuredLiveLabel),
        featuredViewAllLabel: asString(ar.featuredViewAllLabel, def.featuredViewAllLabel),
        featuredCtaTitleLine1: asString(ar.featuredCtaTitleLine1, def.featuredCtaTitleLine1),
        featuredCtaTitleLine2: asString(ar.featuredCtaTitleLine2, def.featuredCtaTitleLine2),
        featuredCtaDescription: asString(ar.featuredCtaDescription, def.featuredCtaDescription),
        featuredCtaButtonText: asString(ar.featuredCtaButtonText, def.featuredCtaButtonText),
        navHome: asString(ar.navHome, def.navHome),
        navAbout: asString(ar.navAbout, def.navAbout),
        navProjects: asString(ar.navProjects, def.navProjects),
        navTestimonials: asString(ar.navTestimonials, def.navTestimonials),
        navContact: asString(ar.navContact, def.navContact),
        navArticles: asString(ar.navArticles, def.navArticles),
        letsTalkLabel: asString(ar.letsTalkLabel, def.letsTalkLabel),
        scene05Badge: asString(ar.scene05Badge, def.scene05Badge),
        scene05Role: asString(ar.scene05Role, def.scene05Role),
        scene05VisionTitle: asString(ar.scene05VisionTitle, def.scene05VisionTitle),
        scene05VisionText: asString(ar.scene05VisionText, def.scene05VisionText),
        scene05StoryTitle: asString(ar.scene05StoryTitle, def.scene05StoryTitle),
        scene05SkillsTitle: asString(ar.scene05SkillsTitle, def.scene05SkillsTitle),
        scene05CertificationsTitle: asString(ar.scene05CertificationsTitle, def.scene05CertificationsTitle),
        scene05CredentialButtonLabel: asString(ar.scene05CredentialButtonLabel, def.scene05CredentialButtonLabel),
        scene05CompanyLogosTitle: asString(ar.scene05CompanyLogosTitle, def.scene05CompanyLogosTitle),
        scene05AiTitle: asString(ar.scene05AiTitle, def.scene05AiTitle),
        scene05AiText: asString(ar.scene05AiText, def.scene05AiText),
        scene05ActionLabel: asString(ar.scene05ActionLabel, def.scene05ActionLabel),
        footerCopyrightText: asString(ar.footerCopyrightText, def.footerCopyrightText),
        footerOfficeTitle: asString(ar.footerOfficeTitle, def.footerOfficeTitle),
        articlesTitle: asString(ar.articlesTitle, def.articlesTitle),
        articlesSubtitle: asString(ar.articlesSubtitle, def.articlesSubtitle),
        articlesDescription: asString(ar.articlesDescription, def.articlesDescription),
        articlesLatestLabel: asString(ar.articlesLatestLabel, def.articlesLatestLabel),
        articlesAllTopicsLabel: asString(ar.articlesAllTopicsLabel, def.articlesAllTopicsLabel),
        articlesSearchPlaceholder: asString(ar.articlesSearchPlaceholder, def.articlesSearchPlaceholder),
        articlesContinueReadingLabel: asString(ar.articlesContinueReadingLabel, def.articlesContinueReadingLabel),
        articlesMinReadLabel: asString(ar.articlesMinReadLabel, def.articlesMinReadLabel),
        articlesUndatedLabel: asString(ar.articlesUndatedLabel, def.articlesUndatedLabel),
        articlesByAuthorPrefix: asString(ar.articlesByAuthorPrefix, def.articlesByAuthorPrefix),
        articlesNotFoundTitle: asString(ar.articlesNotFoundTitle, def.articlesNotFoundTitle),
        articlesNotFoundDescription: asString(ar.articlesNotFoundDescription, def.articlesNotFoundDescription),
        articlesBackLabel: asString(ar.articlesBackLabel, def.articlesBackLabel),
        articlesFeaturedLabel: asString(ar.articlesFeaturedLabel, def.articlesFeaturedLabel),
        articlesNoResultsTitle: asString(ar.articlesNoResultsTitle, def.articlesNoResultsTitle),
        articlesNoResultsDescription: asString(ar.articlesNoResultsDescription, def.articlesNoResultsDescription),
        articlesPreviousLabel: asString(ar.articlesPreviousLabel, def.articlesPreviousLabel),
        articlesNextLabel: asString(ar.articlesNextLabel, def.articlesNextLabel),
        articlesNewsletterTitle: asString(ar.articlesNewsletterTitle, def.articlesNewsletterTitle),
        articlesNewsletterDescription: asString(ar.articlesNewsletterDescription, def.articlesNewsletterDescription),
        articlesNewsletterInputPlaceholder: asString(ar.articlesNewsletterInputPlaceholder, def.articlesNewsletterInputPlaceholder),
        articlesNewsletterButtonLabel: asString(ar.articlesNewsletterButtonLabel, def.articlesNewsletterButtonLabel),
        articlesVideosSectionTitle: asString(ar.articlesVideosSectionTitle, def.articlesVideosSectionTitle),
        articlesVideosSectionDescription: asString(ar.articlesVideosSectionDescription, def.articlesVideosSectionDescription),
        contactHeroTitleLine1: asString(ar.contactHeroTitleLine1, def.contactHeroTitleLine1),
        contactHeroTitleLine2: asString(ar.contactHeroTitleLine2, def.contactHeroTitleLine2),
        contactHeroSubtitle: asString(ar.contactHeroSubtitle, def.contactHeroSubtitle),
        contactDirectContactTitle: asString(ar.contactDirectContactTitle, def.contactDirectContactTitle),
        contactPhoneLabel: asString(ar.contactPhoneLabel, def.contactPhoneLabel),
        contactEmailLabel: asString(ar.contactEmailLabel, def.contactEmailLabel),
        contactOfficeLabel: asString(ar.contactOfficeLabel, def.contactOfficeLabel),
        contactAvailabilityText: asString(ar.contactAvailabilityText, def.contactAvailabilityText),
        contactResponseTimeLabel: asString(ar.contactResponseTimeLabel, def.contactResponseTimeLabel),
        contactResponseTimeDescription: asString(ar.contactResponseTimeDescription, def.contactResponseTimeDescription),
        contactFormTitle: asString(ar.contactFormTitle, def.contactFormTitle),
        contactFormSubtitle: asString(ar.contactFormSubtitle, def.contactFormSubtitle),
        contactFormNameLabel: asString(ar.contactFormNameLabel, def.contactFormNameLabel),
        contactFormNamePlaceholder: asString(ar.contactFormNamePlaceholder, def.contactFormNamePlaceholder),
        contactFormEmailLabel: asString(ar.contactFormEmailLabel, def.contactFormEmailLabel),
        contactFormEmailPlaceholder: asString(ar.contactFormEmailPlaceholder, def.contactFormEmailPlaceholder),
        contactFormSubjectLabel: asString(ar.contactFormSubjectLabel, def.contactFormSubjectLabel),
        contactFormSubjectPlaceholder: asString(ar.contactFormSubjectPlaceholder, def.contactFormSubjectPlaceholder),
        contactFormMessageLabel: asString(ar.contactFormMessageLabel, def.contactFormMessageLabel),
        contactFormMessagePlaceholder: asString(ar.contactFormMessagePlaceholder, def.contactFormMessagePlaceholder),
        contactFormPrivacyText: asString(ar.contactFormPrivacyText, def.contactFormPrivacyText),
        contactFormSubmitButton: asString(ar.contactFormSubmitButton, def.contactFormSubmitButton),
        contactSocialSectionLabel: asString(ar.contactSocialSectionLabel, def.contactSocialSectionLabel),
        contactSocialSectionTitle: asString(ar.contactSocialSectionTitle, def.contactSocialSectionTitle),
        contactSocialSectionDescription: asString(ar.contactSocialSectionDescription, def.contactSocialSectionDescription),
        contactFormSuccessTitle: asString(ar.contactFormSuccessTitle, def.contactFormSuccessTitle),
        contactFormSuccessMessage: asString(ar.contactFormSuccessMessage, def.contactFormSuccessMessage),
        contactValidationRequired: asString(ar.contactValidationRequired, def.contactValidationRequired),
        contactValidationInvalidEmail: asString(ar.contactValidationInvalidEmail, def.contactValidationInvalidEmail),
        contactValidationMinLength: asString(ar.contactValidationMinLength, def.contactValidationMinLength),
      };
    })(),
