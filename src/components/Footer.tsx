...
export const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="w-full bg-white text-[#0a0a0b] border-t border-[#0a0a0b]/10 relative z-10 selection:bg-[#0a0a0b]/10 font-mono uppercase text-[10px] sm:text-[11px] tracking-[0.15em] leading-relaxed"
      style={{ boxShadow: footer.topShadow }}
    >
